...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'role:admin,manager'])->prefix('admin')->group(function (): void {
        ...
        Route::get('/directory/car-type-prices', [DirectoryController::class, 'carTypePrices']);
        Route::patch('/directory/car-type-prices/{type}', [DirectoryController::class, 'updateCarTypePrice']);
