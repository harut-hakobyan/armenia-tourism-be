...
final class UpsertTourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'end_time' => ['nullable', 'required_if:format,group', 'date_format:H:i', 'different:start_time'],
            ...
            'translations.*.inclusions' => ['nullable', 'array', 'max:50'],
            'translations.*.inclusions.*' => ['required', 'string', 'max:1000'],
            'translations.*.exclusions' => ['nullable', 'array', 'max:50'],
            'translations.*.exclusions.*' => ['required', 'string', 'max:1000'],
